...
import 'package:qacc_application/views/pdf_viewer_screen.dart' as _i8;
...
abstract class $AppRouter extends _i9.RootStackRouter {
  ...
  final Map<String, _i9.PageFactory> pagesMap = {
    ...
    PDFViewerRoute.name: (routeData) {
      ...
      return _i9.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i8.PDFViewerScreen(pdfPath: args.pdfPath),
      );
    },
  };
}
...
class AnnualLeaveRequest extends _i9.PageRouteInfo<void> {
  const AnnualLeaveRequest({List<_i9.PageRouteInfo>? children})
      : super(
...
class BottomNavigationBarEmployees extends _i9.PageRouteInfo<void> {
  const BottomNavigationBarEmployees({List<_i9.PageRouteInfo>? children})
      : super(
...
class FormSelectionRoute extends _i9.PageRouteInfo<void> {
  const FormSelectionRoute({List<_i9.PageRouteInfo>? children})
      : super(
...
class FullRouteAdRoute extends _i9.PageRouteInfo<FullRouteAdRouteArgs> {
  FullRouteAdRoute({
  ...
  static const _i9.PageInfo<FullRouteAdRouteArgs> page =
      _i9.PageInfo<FullRouteAdRouteArgs>(name);
}
...
/// generated route for
/// [_i5.ItemsOrderPage]
class ItemsOrderRoute extends _i9.PageRouteInfo<void> {
  const ItemsOrderRoute({List<_i9.PageRouteInfo>? children})
      : super(
...
class LeaveTypeSelectionRoute extends _i9.PageRouteInfo<void> {
  const LeaveTypeSelectionRoute({List<_i9.PageRouteInfo>? children})
      : super(
...
class MaintenanceRequestType extends _i9.PageRouteInfo<void> {
  const MaintenanceRequestType({List<_i9.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i8.PDFViewerScreen]
class PDFViewerRoute extends _i9.PageRouteInfo<PDFViewerRouteArgs> {
  PDFViewerRoute({
  ...
  static const _i9.PageInfo<PDFViewerRouteArgs> page =
      _i9.PageInfo<PDFViewerRouteArgs>(name);
}
