...
@RoutePage()
class DirectManagerLeavesApproval extends StatefulWidget {
  const DirectManagerLeavesApproval({super.key});

  @override
  State<DirectManagerLeavesApproval> createState() =>
      _DirectManagerLeavesApprovalState();
}

class _DirectManagerLeavesApprovalState
    extends State<DirectManagerLeavesApproval> {
 ...
 */
  ...
  Future<void> updateDirectManagerApproval(int leaveId, String status) async {
    final url =
        Uri.parse("https://hr.qacc.ly/php/update_direct_manager_approval.php");
    try {
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final status = request["direct_manager_approval"];
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          child: Text(
                                            isApproved
                                                ? ' تم القبول والإرسال إلى المدير الأعلى'
                                                : 'قبول وإرسال إلى المدير الأعلى',
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodySmall!
                                                .copyWith(
